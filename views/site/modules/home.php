<div class="container-fluid" id="home">
    ...
    <div class="video">
        <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <iframe src="https://www.youtube.com/embed/G8SYYpnXmHk" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="col-md-3 col-md-offset-9 col-sm-3 col-sm-offset-9 col-xs-4 col-xs-offset-8 col-xxs-6 col-xxs-offset-6">
            <div class="share">
                <p>Compartilhe</p>
    ...
    <div class="doctors">
        <div class="col-xs-8 col-xs-offset-2 col-xxs-10 col-xxs-offset-1">
            <p class="large">Você tem interesse em conversar com um médico?</p>
            <a href="#" class="btn btn-primary">Clique aqui</a>
        </div>
    </div>

    <div class="specials">
        <div class="bg-primary col-xs-6 col-xxs-12">
            <h1>Tratamento</h1>
            <p class="large">O tratamento da Medtronic para a insuficiência venosa crônica foi concebido para melhor atender suas nececidades.</p>
            <a href="#" class="btn btn-soft-transparent">Saiba mais</a>
        </div>
        <div class="bg-secondary col-xs-6 col-xxs-12">
            <h1>Histórias</h1>
            <p class="large">Suas varizes contam uma história sobre a sua vida, mas não precisam ser a história da sua vida.</p>
            <a href="#" class="btn btn-soft-transparent">Saiba mais</a>
        </div>
    </div>
